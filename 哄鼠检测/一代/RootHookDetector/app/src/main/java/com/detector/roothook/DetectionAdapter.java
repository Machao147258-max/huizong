...
public class DetectionAdapter extends RecyclerView.Adapter<DetectionAdapter.ViewHolder> {
    ...
    private final List<RootDetector.DetectionResult> results;

    public DetectionAdapter(List<RootDetector.DetectionResult> results) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        RootDetector.DetectionResult result = results.get(position);
